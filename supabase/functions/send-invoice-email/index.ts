      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <div style="background-color: #D95D4E; padding: 20px; text-align: center;">
              <h1 style="color: white; margin: 0;">MR FOG®</h1>
              <p style="color: white; margin: 5px 0;">Sales Manager</p>
            </div>
            ...
            <div style="padding: 30px; background-color: #f9f9f9;">
              ...
              <div style="background-color: white; padding: 20px; border-radius: 5px; margin: 20px 0;">
                ...
                <p style="margin: 10px 0; color: #666;">Total Amount: <strong style="color: #D95D4E; font-size: 18px;">$${totalAmount.toFixed(2)}</strong></p>
              </div>
              
              <p style="color: #666;">If you have any questions, please don't hesitate to contact us.</p>
              <p style="color: #666;">Best regards,<br><strong>MR FOG® Sales Team</strong></p>
            </div>
            
            <div style="background-color: #333; padding: 15px; text-align: center;">
              <p style="color: #999; font-size: 12px; margin: 0;">© 2024 MR FOG®. All rights reserved.</p>
            </div>
          </div>
        `,
        attachments: [
